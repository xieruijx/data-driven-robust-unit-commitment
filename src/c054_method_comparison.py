...
for index_u_l_predict in index_u_l_predict_set:
    ...
    IO().output_UC(30, index_u_l_predict, type_u_l, weight_optimize, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'P1', folder_outputs='./results/outputs/', folder_strategies='./results/strategies/')
    ...
    IO().output_UC(30, index_u_l_predict, type_u_l, weight_error, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'P2', folder_outputs='./results/outputs/', folder_strategies='./results/strategies/')
    ...
    IO().output_UC(30, index_u_l_predict, type_u_l, weight_optimize, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'Proposed', folder_outputs='./results/outputs/', folder_strategies='./results/strategies/')
    ...
    IO().output_UC(30, index_u_l_predict, type_u_l, weight_optimize, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'RO_max', folder_outputs='./results/outputs/', folder_strategies='./results/strategies/')
