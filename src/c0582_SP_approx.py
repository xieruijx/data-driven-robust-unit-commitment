...
print(time)
IO().output_UC(30, index_u_l_predict, type_u_l, weight, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'SP_approx', folder_outputs='./results/outputs/', folder_strategies='./results/strategies/')
