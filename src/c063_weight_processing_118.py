...
df, best_index, best_weight, best_cost = IO().read_weight_cost(index_u_l_predict, type_u_l, epsilon=0.05, name_method='Proposed', folder_number='./data/processed/weight118/', folder_outputs='./data/processed/weight118/outputs/', folder_strategies='./data/processed/weight118/strategies/')
