...
for index_u_l_predict in index_u_l_predict_set:
    ...
    # IO().output_UC(index_u_l_predict, type_u_l, weight_optimize, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'RO_max', folder_outputs='./results/outputs/118/', folder_strategies='./results/strategies/118/')
    ...
    # validation_cost, test_cost, sxb1, sxc1, LBUB1, sxb2, sxc2, LBUB2, time, train_cost, train_order, interpret = optimization.weight2cost(parameter_smallMaxIter, weight_optimize, 'n1', 'approx', index_u_l_predict, 'case118', type_u_l)
    # IO().output_UC(index_u_l_predict, type_u_l, weight_optimize, train_cost, train_order, validation_cost, test_cost, LBUB1, LBUB2, time, interpret, 'SP_approx', folder_outputs='./results/outputs/118/', folder_strategies='./results/strategies/118/')
