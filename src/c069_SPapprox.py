...
parameter['MaxIter'] = 15 # Maximum iteration number of CCG
...
validation_cost, test_cost, sxb1, sxc1, LBUB1, time1 = optimization.weight2cost_SPapprox(parameter, weight, index_u_l_predict, name_case)
